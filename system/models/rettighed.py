...
class Rettighed(models.Model):
    RETTIGHED = (
        ...
        ('arkiveringsversioner_leverandoer_av_rediger', 'arkiveringsversioner_leverandoer_av_rediger'),
        ...
        ('arkiveringsversioner_stoerrelse_rediger', 'arkiveringsversioner_stoerrelse_rediger'),
        ('arkiveringsversioner_maskine_se', 'arkiveringsversioner_maskine_se'),

        ('arkiveringsversioner_status_afventer_aflevering_se', 'arkiveringsversioner_status_afventer_aflevering_se'),
        ('arkiveringsversioner_status_afventer_aflevering_rediger', 'arkiveringsversioner_status_afventer_aflevering_rediger'),
        ...
        ('arkiveringsversioner_status_klar_til_test_se', 'arkiveringsversioner_status_klar_til_test_se'),
        ('arkiveringsversioner_status_klar_til_test_rediger', 'arkiveringsversioner_status_klar_til_test_rediger'),
        ('arkiveringsversioner_status_under_test_se', 'arkiveringsversioner_status_under_test_se'),
        ('arkiveringsversioner_status_under_test_rediger', 'arkiveringsversioner_status_under_test_rediger'),
        ('arkiveringsversioner_status_tilbagemeldt_se', 'arkiveringsversioner_status_tilbagemeldt_se'),
        ('arkiveringsversioner_status_tilbagemeldt_rediger', 'arkiveringsversioner_status_tilbagemeldt_rediger'),
        ('arkiveringsversioner_status_afventer_genaflevering_se', 'arkiveringsversioner_status_afventer_genaflevering_se'),
        ('arkiveringsversioner_status_afventer_genaflevering_rediger', 'arkiveringsversioner_status_afventer_genaflevering_rediger'),
        ('arkiveringsversioner_status_godkendt_af_tester_se', 'arkiveringsversioner_status_godkendt_af_tester_se'),
        ('arkiveringsversioner_status_godkendt_af_tester_rediger', 'arkiveringsversioner_status_godkendt_af_tester_rediger'),
        ('arkiveringsversioner_status_parat_til_godkendelse_se', 'arkiveringsversioner_status_parat_til_godkendelse_se'),
        ('arkiveringsversioner_status_parat_til_godkendelse_rediger', 'arkiveringsversioner_status_parat_til_godkendelse_rediger'),
        ('arkiveringsversioner_status_godkendt_se', 'arkiveringsversioner_status_godkendt_se'),
        ('arkiveringsversioner_status_godkendt_rediger', 'arkiveringsversioner_status_godkendt_rediger'),

        ('arkiveringsversioner_leverandrerer_se',    'arkiveringsversioner_leverandoerer_se'),
        ('arkiveringsversioner_leverandoer_se',      'arkiveringsversioner_leverandoer_se'),
        ('arkiveringsversioner_leverandoer_rediger', 'arkiveringsversioner_leverandoer_rediger'),
        ('arkiveringsversioner_leverandoer_opret',   'arkiveringsversioner_leverandoer_opret'),
        ('arkiveringsversioner_leverandoer_slet',    'arkiveringsversioner_leverandoer_slet'),
