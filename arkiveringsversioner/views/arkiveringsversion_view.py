    ...
    if request.method == 'GET':
        ...
        if Arkiveringsversion.objects.filter(avid=avid).exists():
            ...
            return render(request, 'arkiveringsversioner/arkiveringsversion.html', {
                ...
                "modtaget_afvikler_ada": _version_obj.modtaget_afvikler_ada,
                "modtaget_ada_fejlet": _version_obj.modtaget_ada_fejlet,
                "modtaget_klar_til_test": _version_obj.modtaget_klar_til_test,
